...
import styles from "./MentionCgu.module.scss";

export default function MentionCgu() {
  return (
    <div className={`${styles.cguContainer}`}>
      <h1>Mentions légales et CGU</h1>
      <h2>Conditions générales d'utilisation & Mentions Légales</h2>
      <p>En vigueur au 01/10/2023</p>
      <p>
        ...
        du site et des services par Van Bouchotte Michaël et de définir les
        ...
        services proposés par le site. Van Bouchotte Michaël se réserve le droit
        de modifier unilatéralement et à tout moment le contenu des présentes
        CGU.
      </p>
      <h3>ARTICLE 1 : Les mentions légales</h3>
      <p>
        L’édition et la direction de la publication du site Memory est assurée
        par Van Bouchotte Michaël, domicilié 207 rue de la liberté Béthune.
        Numéro de téléphone est 0606863904 Adresse e-mail
        michael.vanbouchotte1@gmail.com.
      </p>
      <h3>ARTICLE 2 : Accès au site</h3>
      <p>
        Le site Memory permet à l'Utilisateur un accès gratuit aux services
        suivants : Le site internet propose les services suivants : Permettre
        aux utilisateurs de jouer à une version numérique du jeu memory,
        permettre à l'utilisateur de sauvegarder son score Le site est
        accessible gratuitement en tout lieu à tout Utilisateur ayant un accès à
        ...
        acceptant de s’inscrire aux services réservés, l’Utilisateur membre
        s’engage à fournir des informations sincères et exactes concernant son
        état civil et ses coordonnées, notamment son adresse email. Pour accéder
        aux services, l’Utilisateur doit ensuite s'identifier à l'aide de son
        ...
        la responsabilité de Van Bouchotte Michaël. Dans ces cas, l’Utilisateur
      ...
      <p>
        ...
        : · par mail à l'adresse email memorycda@gmail.com · via son espace
        personnel ;
      </p>
      ...
      <p>
        Les sources des informations diffusées sur le site Memory sont réputées
        fiables mais le site ne garantit pas qu’il soit exempt de défauts,
        d’erreurs ou d’omissions. Les informations communiquées sont présentées
        à titre indicatif et général sans valeur contractuelle. Malgré des mises
        à jour régulières, le site Memory ne peut être tenu responsable de la
        ...
        passe. Le site décline toute responsabilité. Le site Memory ne peut être
      ...
      <p>
        ...
        est informé qu’en cliquant sur ces liens, il sortira du site Memory. Ce
      ...
      <p>
        ...
        nécessaires à l’utilisation du site Memory. Les cookies ne contiennent
        ...
        les cookies est utilisée pour améliorer le site Memory. En naviguant sur
        le site, L’Utilisateur les accepte. L’Utilisateur pourra désactiver ces
